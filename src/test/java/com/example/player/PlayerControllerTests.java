...
public class PlayerControllerTests {
        ...
        public void testpost() throws Exception {
                Player player = new Player(0, "Prince", 24, "Bowler");
        ...
        public void testDbAfterPost() throws Exception {
                Player player = playerJpaRepository.findById(12).get();
        ...
        public void testput() throws Exception {
                Player player = new Player(0, "Yuvi", 12, "All-rounder");
                String content = objectWriter.writeValueAsString(player);
        ...
        public void testDbAfterPut() throws Exception {
                Player player = playerJpaRepository.findById(3).get();
